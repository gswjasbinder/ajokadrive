        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Dashboard</h2>   
                        <h5>Welcome <?php echo $_SESSION["FirstName"]; ?> , Love to see you on Ajoka Drive. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
...
$id = $_SESSION["UserID"]; // get id through query string

$qry = mysqli_query($con,"select * from USER where UserID='$id'"); // select query
...
if(isset($_POST['update'])) // when click on Update button
{
   $id = $_SESSION["UserID"];
    ...
    $edit = mysqli_query($con,"update USER set FirstName =' $FirstName', LastName=' $LastName', Email='$Email', ContactNumber=' $ContactNumber', DateOfBirth='$DateOfBirth' where UserID='$id'");
}
    else
    {
        echo mysqli_error();
...
<form method="POST">
  <input type="text" name="FirstName" value="<?php echo $data["FirstName"] ?>" placeholder="Enter Full Name" Required>
